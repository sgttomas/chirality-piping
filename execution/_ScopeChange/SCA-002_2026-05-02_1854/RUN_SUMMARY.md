...
SCA-002 updated `execution/_Decomposition/SOFTWARE_DECOMP.md` from revision 0.4 to revision 0.5 and synchronized the companion registers under `docs/_Registers/`.

The amendment adds 13 scope items, 5 objectives, 4 packages, and 19 deliverables. It records PRD v0.2 as the working product-design basis while preserving existing stable IDs and existing solver/professional-boundary scope.
