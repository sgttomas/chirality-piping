# Semantic Lensing Register: DEL-06-02 Sandboxed unit-aware expression evaluator

**Generated:** 2026-04-30
**Deliverable Folder:** `/Users/ryan/ai-env/projects/chirality-piping/execution/PKG-06_Rule Packs and User-Supplied Code Check Engine/1_Working/DEL-06-02_Sandboxed unit-aware expression evaluator`
**Warnings:** None.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| A-001 | A:[normative]:[applying] | VerificationGap | Specification | Specification | Add future acceptance checks proving unsafe expression forms and adapter bypass attempts are rejected. | The setup boundary requires sandboxing but implementation must prove the boundary with tests. | ./Specification.md | Specification.md#Verification | N/A | PROPOSAL: Specification should own evaluator security acceptance checks. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| B-001 | B:[data]:[completeness] | MissingSlot | Datasheet | Datasheet | Record TBD final diagnostic-code taxonomy for unsafe expression, unit mismatch, missing binding, and boundary-violation findings. | Setup documents identify diagnostic families but do not decide final codes. | ./Datasheet.md; ./Specification.md | Datasheet.md#Conditions; Specification.md#Open-Decisions | N/A | PROPOSAL: Datasheet should retain descriptive TBDs until implementation scope is sealed. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| C-001 | C:[operative]:[consistency] | Normalization | Multi | Guidance | Maintain one vocabulary for evaluator, expression, variable binding, rule-pack check, user-rule checked, and human review. | Terms are consistent enough for setup but future implementation needs controlled vocabulary to prevent authority-boundary drift. | ./Datasheet.md; ./Specification.md; ./Guidance.md; ./Procedure.md | entire document scanned | N/A | PROPOSAL: Guidance should own terminology rationale. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| F-001 | F:[normative]:[necessity] | TBD_Question | Specification | Specification | TBD: decide expression grammar/library and evaluator safety model before implementation. | Accessible setup sources identify the boundary but leave the exact expression grammar/library TBD. | ./Specification.md; ./Guidance.md | Specification.md#Open-Decisions; Guidance.md#Trade-offs | N/A | PROPOSAL: Future implementation brief should seal grammar and evaluator decisions. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| D-001 | D:[operative]:[applying] | WeakStatement | Procedure | Procedure | Clarify future implementation handoff to unit-system, rule-pack schema, and result-envelope providers once interfaces are sealed. | Procedure identifies dependencies generally but exact integration points remain TBD. | ./Procedure.md; ./Specification.md | Procedure.md#Prerequisites; Specification.md#Open-Decisions | N/A | PROPOSAL: Procedure should capture future handoff workflow. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| X-001 | X:[applying]:[necessity] | VerificationGap | Specification | Specification | Add future tests proving plugins and adapters cannot bypass sandboxing, unit validation, provenance checks, or diagnostics. | The adapter boundary is normative and needs verification once implementation exists. | ./Specification.md; ./Guidance.md | Specification.md#Verification; Guidance.md#Principles | N/A | PROPOSAL: Specification should own bypass-prevention tests. | TBD |
