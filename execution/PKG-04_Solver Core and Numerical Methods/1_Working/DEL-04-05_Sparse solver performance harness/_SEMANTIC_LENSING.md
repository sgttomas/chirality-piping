# Semantic Lensing Register: DEL-04-05 Sparse Solver Performance Harness

**Generated:** 2026-04-30
**Deliverable Folder:** `/Users/ryan/ai-env/projects/chirality-piping/execution/PKG-04_Solver Core and Numerical Methods/1_Working/DEL-04-05_Sparse solver performance harness`
**Warnings:** No production documents were missing. Matrix coverage is complete for A, B, C, F, D, X, and E.

**Inputs Read:**
- _CONTEXT.md - `_CONTEXT.md#context-del-04-05`
- _STATUS.md - `_STATUS.md#status-del-04-05-sparse-solver-performance-harness`
- _SEMANTIC.md - `_SEMANTIC.md#deliverable-del-04-05-sparse-solver-performance-harness`
- Datasheet.md - `Datasheet.md#datasheet-del-04-05-sparse-solver-performance-harness`
- Specification.md - `Specification.md#specification-del-04-05-sparse-solver-performance-harness`
- Guidance.md - `Guidance.md#guidance-del-04-05-sparse-solver-performance-harness`
- Procedure.md - `Procedure.md#procedure-del-04-05-sparse-solver-performance-harness`
- _REFERENCES.md - `_REFERENCES.md#references-del-04-05-sparse-solver-performance-harness`
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| A-001 | A:[normative]:[guiding] | TBD_Question | Datasheet | Datasheet | TBD: identify human authority for sparse library choice, threshold policy, and fixture-source approval. | Open setup questions require named owners before implementation can close. | Datasheet.md | Open Setup Questions | NA | PROPOSAL: keep authority unresolved until assigned. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| B-001 | B:[data]:[completeness] | MissingSlot | Datasheet; Procedure | Datasheet | Add a future fixture provenance slot once harness implementation is authorized. | Fixture provenance is required by IP/data-boundary constraints but concrete fixture records do not exist in setup. | Datasheet.md; Procedure.md | Attributes; Records | NA | PROPOSAL: add only when fixtures exist. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| C-001 | C:[normative]:[sufficiency] | VerificationGap | Specification | Specification | Add approved acceptance criteria when tolerance and threshold policy is decided. | Requirements intentionally leave determinism and performance thresholds as `TBD`; future implementation needs citable criteria. | Specification.md | Requirements; Verification | NA | PROPOSAL: block release gating until policy exists. | TBD |

## Matrix F - Persistence
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| F-001 | F:[operative]:[necessity] | VerificationGap | Procedure | Procedure | Add exact run-record schema once result-envelope and benchmark runner contracts exist. | Procedure names records but concrete schema is not available in setup. | Procedure.md | Records | NA | PROPOSAL: defer until implementation brief. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| D-001 | D:[evaluative]:[sufficiency] | RationaleGap | Guidance | Guidance | Add rationale for chosen CI timing policy after timing gate strategy is approved. | Guidance flags timing sensitivity, but approved CI policy is not yet available. | Guidance.md | Trade-offs | NA | PROPOSAL: defer gate rationale until human threshold decision. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| X-001 | X:[data]:[necessity] | TBD_Question | Specification; Procedure | Specification | TBD: identify which upstream solver/result-envelope deliverables provide required data contracts. | The kit references accepted solver/result contracts but does not name finalized artifacts because those are outside the setup scope. | Specification.md; Procedure.md | Documentation; Prerequisites | NA | PROPOSAL: resolve by dependency refresh when upstream deliverables mature. | TBD |
