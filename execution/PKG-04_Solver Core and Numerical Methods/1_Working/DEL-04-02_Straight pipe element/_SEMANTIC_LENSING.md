# Semantic Lensing Register: DEL-04-02 Straight pipe element

**Generated:** 2026-04-30
**Deliverable Folder:** `/Users/ryan/ai-env/projects/chirality-piping/execution/PKG-04_Solver Core and Numerical Methods/1_Working/DEL-04-02_Straight pipe element`
**Warnings:** None.
...
- By document: Datasheet 2; Specification 3; Guidance 2; Procedure 2
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| A-001 | A:[normative]:[guiding] | TBD_Question | Datasheet | Datasheet | Identify the human/project authority for solver interface, unit, diagnostic, and fixture-policy rulings. | Open setup questions have no named owner yet. | Datasheet.md | Open Setup Questions | NA | Keep as TBD until assigned. | TBD |
...
| B:[data]:[completeness] | data | completeness | comprehensive record | 1 | HAS_ITEMS | Missing data-slot item recorded. |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| B-001 | B:[data]:[completeness] | MissingSlot | Datasheet | Datasheet | Add explicit placeholders for accepted section-property fields, unit API, diagnostic codes, and solver result components. | Datasheet records these as TBD but not as a controlled checklist. | Datasheet.md | Conditions; Open Setup Questions | NA | Record placeholders only. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| C-001 | C:[normative]:[sufficiency] | VerificationGap | Specification | Specification | Add accepted deterministic verification cases for stiffness and force recovery once fixture policy is approved. | Specification requires tests but exact benchmark cases are TBD. | Specification.md | Verification | NA | Use synthetic or cleared cases only. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| F-001 | F:[normative]:[sufficiency] | VerificationGap | Procedure | Procedure | Add record-level evidence requirements for unit, fixture provenance, and protected-content checks. | Procedure names verification areas but exact evidence artifacts remain TBD. | Procedure.md | Verification; Records | NA | Keep evidence placeholders explicit. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| D-001 | D:[operative]:[applying] | TBD_Question | Guidance | Guidance | Resolve whether local-to-global transformation belongs here or exclusively in DEL-04-01. | Guidance warns that solver kernel boundaries are unresolved. | Guidance.md | Trade-offs | NA | Route to architecture/solver owner. | TBD |
...
| X:[reviewing]:[completeness] | reviewing | completeness | audit coverage gate | 1 | HAS_ITEMS | Test completeness item recorded. |
| X:[reviewing]:[consistency] | reviewing | consistency | audit coherence gate | 0 | NO_ITEMS | No additional warranted item. |

### Warranted Items
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| X-001 | X:[reviewing]:[completeness] | MissingSlot | Specification | Specification | Add explicit coverage slots for stiffness, section-property integration, weight hooks, and force recovery. | Current verification areas are grouped and need implementable coverage slots. | Specification.md | Verification | NA | Add slots without adding numeric values. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| E-001 | E:[applying]:[information] | RationaleGap | Guidance | Guidance | Add rationale for how force recovery output is consumed by downstream stress recovery without embedding code stress checks. | The boundary is stated but downstream interpretation remains open. | Guidance.md | Principles; Trade-offs | NA | Cite downstream stress contract when available. | TBD |
