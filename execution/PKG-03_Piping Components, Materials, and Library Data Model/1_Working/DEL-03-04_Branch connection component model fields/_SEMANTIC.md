# Semantic Lens: DEL-03-04 Branch connection component model fields

**Generated:** 2026-04-30
**DECOMP_VARIANT:** SOFTWARE
**Perspective:** This deliverable frames branch connection component data as a bounded software model for user-supplied geometry, reinforcement, SIF, flexibility, local data, units, and provenance. The lens separates field coverage, validation, and protected-data boundaries without deciding engineering values or code-specific methods.
**Framework:** Chirality Semantic Algebra
**Inputs Read:**
- _CONTEXT.md - deliverable identity, architecture basis, scope/objective references
...
For each cell, `L_C(row,col)` is the ordered collection of four products from the row of A and the column of B. Interpretation uses: Step 1 axis anchor `a = row * col`; Step 2 projections `p1..p4 = a * each contributor`; Step 3 centroid selection into one semantic unit. The full operation was applied to every C cell; the compact work table records all three steps without preserving algebra operators in final cells.

| Cell | L_C contributors | Step 1 axis anchor | Step 2 projections | Step 3 centroid |
|---|---|---|---|---|
| C:normative:necessity | prescriptive fact; mandatory signal; compliance understanding; audit discernment | binding need | required evidence; required signal; required understanding; required discernment | required evidence frame |
| C:normative:sufficiency | prescriptive evidence; mandatory context; compliance expertise; audit judgment | binding adequacy | adequate proof; adequate context; competent proof; judged adequacy | adequate proof basis |
| C:normative:completeness | prescriptive record; mandatory account; compliance mastery; audit insight | binding coverage | complete record; complete account; mastered coverage; holistic audit | complete obligation record |
| C:normative:consistency | prescriptive measurement; mandatory message; compliance understanding; audit reasoning | binding coherence | reliable measure; coherent instruction; coherent judgment; principled review | coherent rule record |
...
|---|---|---|---|---|
| F:normative:necessity | evidence fact; proof signal; obligation understanding; rule discernment | binding need | required fact; proof signal; obligation comprehension; rule discernment | required field evidence |
| F:normative:sufficiency | evidence proof; proof context; obligation expertise; rule judgment | binding adequacy | adequate evidence; contextual proof; expert obligation; judged rule | sufficient field proof |
| F:normative:completeness | evidence record; proof account; obligation mastery; rule insight | binding coverage | complete evidence; proof account; obligation coverage; rule insight | complete field coverage |
| F:normative:consistency | evidence measure; proof message; obligation understanding; rule reasoning | binding coherence | measured evidence; coherent proof; stable obligation; rule reasoning | consistent field semantics |
...
| F:operative:sufficiency | input evidence; context adequacy; process expertise; execution judgment | action adequacy | adequate input; usable context; process competence; execution judgment | sufficient workflow context |
| F:operative:completeness | input record; context account; process mastery; execution insight | action coverage | complete input; context account; process coverage; execution insight | complete workflow coverage |
| F:operative:consistency | input measurement; context message; process understanding; execution reasoning | action coherence | reliable input; coherent context; stable process; execution reasoning | consistent workflow signal |
...
| | **necessity** | **sufficiency** | **completeness** | **consistency** |
|---|---|---|---|---|
| **normative** | required field evidence | sufficient field proof | complete field coverage | consistent field semantics |
| **operative** | required workflow input | sufficient workflow context | complete workflow coverage | consistent workflow signal |
...
|---|---|---|---|---|
| D:normative:guiding | prescriptive direction; resolved field evidence | binding guidance | directed obligation; resolved evidence | evidence-bound direction |
| D:normative:applying | mandatory practice; resolved field proof | binding action | required practice; resolved proof | proof-bound practice |
| D:normative:judging | compliance determination; resolved field coverage | binding judgment | compliance decision; resolved coverage | coverage-bound judgment |
| D:normative:reviewing | regulatory audit; resolved field semantics | binding review | audit check; resolved semantics | semantics-bound review |
...
| D:operative:applying | practical execution; resolved workflow context | action application | execution practice; resolved context | context-bound execution |
| D:operative:judging | performance assessment; resolved workflow coverage | action judgment | performance check; resolved coverage | coverage-bound assessment |
| D:operative:reviewing | process audit; resolved workflow signal | action review | process audit; resolved signal | signal-bound audit |
...
| **operative** | input-bound procedure | context-bound execution | coverage-bound assessment | signal-bound audit |
...
| **applying** | proof-bound practice | context-bound execution | proof-bound appraisal |
...
| X:applying:necessity | practice fact; execution signal; appraisal understanding | application need | practice fact; execution signal; appraisal understanding | necessary application evidence |
| X:applying:sufficiency | practice evidence; execution context; appraisal expertise | application adequacy | practice proof; execution context; appraisal expertise | sufficient application context |
| X:applying:completeness | practice record; execution account; appraisal mastery | application coverage | practice record; execution account; appraisal mastery | complete application record |
| X:applying:consistency | practice measurement; execution message; appraisal understanding | application coherence | measured practice; execution message; coherent appraisal | consistent application meaning |
...
| E:applying:information | application signal; application context; application account; application message | application information | signal application; contextual application; account application; coherent application | application information quality |
| E:applying:knowledge | application understanding; application expertise; application mastery; application coherence | application knowledge | understood application; expert application; mastered application; coherent application | application knowledge quality |
| E:applying:wisdom | application discernment; application judgment; application insight; application reasoning | application wisdom | discerning application; judged application; insightful application; reasoned application | application judgment quality |
...
| E:judging:information | judgment signal; judgment context; judgment account; judgment message | judgment information | signal judgment; contextual judgment; account judgment; coherent judgment | judgment information quality |
| E:judging:knowledge | judgment understanding; judgment expertise; judgment mastery; judgment coherence | judgment knowledge | understood judgment; expert judgment; mastered judgment; coherent judgment | judgment knowledge quality |
| E:judging:wisdom | judgment discernment; judgment judgment; judgment insight; judgment reasoning | judgment wisdom | discerning judgment; judged judgment; insightful judgment; reasoned judgment | judgment reasoning quality |
...
| E:reviewing:information | review signal; review context; review account; review message | review information | signal review; contextual review; account review; coherent review | review information quality |
| E:reviewing:knowledge | review understanding; review expertise; review mastery; review coherence | review knowledge | understood review; expert review; mastered review; coherent review | review knowledge quality |
| E:reviewing:wisdom | review discernment; review judgment; review insight; review reasoning | review wisdom | discerning review; judged review; insightful review; reasoned review | review reasoning quality |
...
- No branch engineering values, equipment tags, code clauses, tables, formulas, or compliance claims are introduced.
- Audit result: PASS.
