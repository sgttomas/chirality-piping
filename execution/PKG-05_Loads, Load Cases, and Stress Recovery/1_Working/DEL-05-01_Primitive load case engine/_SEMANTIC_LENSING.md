# Semantic Lensing Register: DEL-05-01 Primitive load case engine

**Generated:** 2026-04-30
**Deliverable Folder:** `/Users/ryan/ai-env/projects/chirality-piping/execution/PKG-05_Loads, Load Cases, and Stress Recovery/1_Working/DEL-05-01_Primitive load case engine`
**Warnings:** None.

**Inputs Read:**
- _CONTEXT.md - `./_CONTEXT.md#Context-DEL-05-01`
- _STATUS.md - `./_STATUS.md#Status-DEL-05-01-Primitive-load-case-engine`
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| A-001 | A:[normative]:[applying] | VerificationGap | Specification | Specification | Add future acceptance checks proving primitive load categories cannot bypass unit validation and explicit missing-value findings. | Specification defines boundaries, but future implementation will need concrete acceptance checks around unit-aware load application and missing-input behavior. | ./Specification.md | Specification.md#Requirements; Specification.md#Verification | N/A | PROPOSAL: Specification should own load-definition acceptance checks. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| B-001 | B:[data]:[completeness] | MissingSlot | Datasheet | Datasheet | Record TBD input provenance fields for every primitive category, including value source, unit, dimensional type, and unresolved state. | The category register is complete for SOW-013, but final input-field provenance is not sealed. | ./Datasheet.md; ./Specification.md | Datasheet.md#Primitive-Load-Category-Register; Specification.md#Requirements | N/A | PROPOSAL: Datasheet should retain descriptive TBDs until schema scope is sealed. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| C-001 | C:[operative]:[consistency] | Normalization | Multi | Guidance | Add future vocabulary guidance distinguishing primitive category, load case, load algebra, load combination, and rule-pack evaluation. | The documents preserve boundaries, but downstream implementation and tests would benefit from one vocabulary note. | ./Datasheet.md; ./Specification.md; ./Guidance.md; ./Procedure.md | entire document scanned | N/A | PROPOSAL: Guidance should own terminology rationale. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| F-001 | F:[normative]:[necessity] | TBD_Question | Specification | Specification | TBD: decide minimum schema fields for each primitive load category before implementation. | SOW-013 lists categories, but accessible sources do not define final field sets for category-specific inputs. | ./Specification.md; ./Guidance.md | Specification.md#Requirements; Guidance.md#Considerations | N/A | PROPOSAL: Future implementation brief or human ruling should set schema policy. | TBD |
| F-002 | F:[normative]:[sufficiency] | WeakStatement | Specification | Specification | Clarify minimum provenance fields for user-supplied values, lawful imports, unresolved TBDs, and diagnostics. | Specification requires provenance but does not define the final minimum field set beyond AB-00-06. | ./Specification.md | Specification.md#Requirements | N/A | PROPOSAL: Specification should define minimum provenance evidence. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| D-001 | D:[operative]:[applying] | MissingSlot | Procedure | Procedure | Add future implementation step for selecting deterministic load-application fixtures after schema scope is sealed. | Procedure gives setup steps but does not yet outline fixture selection for each primitive category. | ./Procedure.md; ./Guidance.md | Procedure.md#Steps; Guidance.md#Trade-offs | N/A | PROPOSAL: Procedure should capture future load-fixture workflow. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| X-001 | X:[reviewing]:[completeness] | VerificationGap | Specification | Specification | Add release-gate checks confirming load application tests cover all SOW-013 primitive categories before release use. | Verification mentions deterministic tests, but future acceptance should explicitly link primitive load coverage to release gates. | ./Specification.md | Specification.md#Verification | N/A | PROPOSAL: Specification should require primitive load test gate coverage. | TBD |
...
| ItemID | LensKey | Type | AppliesToDoc | SuggestedEditDoc | CandidateInfo | WhyWarranted | SourcePath | SectionRef | Contenders | ProposedAuthority (PROPOSAL) | HumanRuling |
|---|---|---|---|---|---|---|---|---|---|---|---|
| E-001 | E:[reviewing]:[data] | RationaleGap | Guidance | Guidance | Explain why coefficients/defaults remain TBD and how future values must be justified without implying compliance. | Guidance marks code-specific/default values as TBD, but future contributors need rationale to avoid inventing or overclaiming load policy. | ./Guidance.md | Guidance.md#Considerations; Guidance.md#Trade-offs | N/A | PROPOSAL: Guidance should carry value/default rationale boundaries. | TBD |
