# Semantic Lens: DEL-08-02 Audit manifest and model hash

**Generated:** 2026-04-30
**DECOMP_VARIANT:** SOFTWARE
**Perspective:** This deliverable frames reproducibility metadata for model identity, input manifesting, solver versioning, rule-pack checksum capture, and asset digest handling. It partitions the work into types of traceability, determinism, review evidence, and boundary protection without specifying implementation code, project-specific values, or protected payloads.
...
- Datasheet.md - setup draft for descriptive manifest fields.
...
|---|---|---|---|---|---|
| C[normative,necessity] | direction fact; practice signal; determination understanding; audit discernment | rule basis | p1=binding source; p2=required cue; p3=decidable rationale; p4=inspection trigger | source mandate | traceability mandate |
...
| C[normative,completeness] | direction record; practice account; determination mastery; audit insight | rule coverage | p1=covered instruction; p2=complete account; p3=mastered scope; p4=holistic review | full record | manifest coverage |
| C[normative,consistency] | direction measurement; practice message; determination understanding; audit reasoning | rule coherence | p1=stable measure; p2=aligned message; p3=coherent basis; p4=principled audit | stable rule | canonical coherence |
| C[operative,necessity] | direction fact; execution signal; assessment understanding; audit discernment | work need | p1=input trigger; p2=execution cue; p3=usable basis; p4=inspection need | required capture | capture prerequisite |
| C[operative,sufficiency] | direction evidence; execution context; assessment expertise; audit judgment | work adequacy | p1=work proof; p2=context ready; p3=operable skill; p4=checkable judgment | ready record | record readiness |
| C[operative,completeness] | direction record; execution account; assessment mastery; audit insight | work coverage | p1=listed input; p2=workflow account; p3=complete handling; p4=insightful trace | full inventory | asset inventory |
| C[operative,consistency] | direction measurement; execution message; assessment understanding; audit reasoning | work coherence | p1=repeatable measure; p2=stable message; p3=understood flow; p4=reasoned audit | stable flow | repeatable ordering |
...
| C[evaluative,sufficiency] | orientation evidence; application context; determination expertise; appraisal judgment | value adequacy | p1=supporting proof; p2=context fit; p3=competent review; p4=judged worth | defensible proof | reviewable evidence |
...
| C[evaluative,consistency] | orientation measurement; application message; determination understanding; appraisal reasoning | value coherence | p1=reliable measure; p2=aligned application; p3=coherent grasp; p4=reasoned appraisal | reliable assessment | audit reliability |

### Result

| | **necessity** | **sufficiency** | **completeness** | **consistency** |
|---|---|---|---|---|
| **normative** | traceability mandate | evidence threshold | manifest coverage | canonical coherence |
| **operative** | capture prerequisite | record readiness | asset inventory | repeatable ordering |
| **evaluative** | boundary criterion | reviewable evidence | closure inventory | audit reliability |
...
| Cell | Intermediate collection | Step 1: axis anchor | Step 2: projected contributors | Step 3: centroid | Result |
|---|---|---|---|---|---|
| F[normative,necessity] | mandate fact; threshold signal; coverage understanding; coherence discernment | rule basis | p1=required identity; p2=minimum cue; p3=coverage basis; p4=stable discernment | binding digest rule | hashing contract |
...
| F[normative,completeness] | mandate record; threshold account; coverage mastery; coherence insight | rule coverage | p1=required record; p2=accounted proof; p3=complete scope; p4=coherent insight | exhaustive manifest | manifest completeness |
| F[normative,consistency] | mandate measurement; threshold message; coverage understanding; coherence reasoning | rule coherence | p1=stable measure; p2=aligned threshold; p3=understood coverage; p4=reasoned stability | canonical stability | canonical stability |
| F[operative,necessity] | prerequisite fact; readiness signal; inventory understanding; ordering discernment | work need | p1=capture trigger; p2=ready cue; p3=list basis; p4=ordered need | required workflow | capture workflow |
| F[operative,sufficiency] | prerequisite evidence; readiness context; inventory expertise; ordering judgment | work adequacy | p1=workflow proof; p2=ready context; p3=inventory competence; p4=ordered judgment | stamped execution | version stamping |
| F[operative,completeness] | prerequisite record; readiness account; inventory mastery; ordering insight | work coverage | p1=needed list; p2=complete account; p3=inventory mastery; p4=ordered insight | complete listing | asset enumeration |
| F[operative,consistency] | prerequisite measurement; readiness message; inventory understanding; ordering reasoning | work coherence | p1=repeatable measure; p2=stable readiness; p3=understood list; p4=ordered reason | reproducible run | deterministic generation |
...
| F[evaluative,sufficiency] | criterion evidence; evidence context; inventory expertise; reliability judgment | value adequacy | p1=review proof; p2=adequate context; p3=complete competence; p4=reliable judgment | replay trust | replay confidence |
...
| | **necessity** | **sufficiency** | **completeness** | **consistency** |
|---|---|---|---|---|
| **normative** | hashing contract | provenance proof | manifest completeness | canonical stability |
| **operative** | capture workflow | version stamping | asset enumeration | deterministic generation |
| **evaluative** | boundary verification | replay confidence | coverage assessment | integrity check |
...
| Cell | Intermediate collection | Step 1: axis anchor | Step 2: projected contributors | Step 3: centroid | Result |
|---|---|---|---|---|---|
| D[normative,guiding] | prescriptive direction; resolved hashing contract | policy frame | p1=bounded instruction; p2=closed digest rule | governed direction | boundary charter |
| D[normative,applying] | mandatory practice; resolved provenance proof | policy action | p1=required practice; p2=closed evidence | required capture | capture mandate |
| D[normative,judging] | compliance determination; resolved manifest completeness | policy decision | p1=decision rule; p2=closed record | integrity decision | integrity ruling |
| D[normative,reviewing] | regulatory audit; resolved canonical stability | policy inspection | p1=audit frame; p2=closed stability | governed inspection | audit protocol |
| D[operative,guiding] | procedural direction; resolved capture workflow | work frame | p1=method direction; p2=closed workflow | usable method | workflow direction |
| D[operative,applying] | practical execution; resolved version stamping | work action | p1=execution move; p2=closed stamp | assembled record | manifest assembly |
| D[operative,judging] | performance assessment; resolved asset enumeration | work decision | p1=performance check; p2=closed list | operational review | execution assessment |
...
| D[evaluative,applying] | merit application; resolved replay confidence | appraisal action | p1=applied merit; p2=closed replay | applied proof | evidence application |
...
| | **guiding** | **applying** | **judging** | **reviewing** |
|---|---|---|---|---|
| **normative** | boundary charter | capture mandate | integrity ruling | audit protocol |
| **operative** | workflow direction | manifest assembly | execution assessment | process trace |
...
| **applying** | capture mandate | manifest assembly | evidence application |
...
| E[applying,data] | readiness fact; proof evidence; capture record; execution measurement | action datum | p1=ready fact; p2=workflow proof; p3=captured record; p4=stable measure | captured facts | capture facts |
| E[applying,information] | readiness signal; proof context; capture account; execution message | action message | p1=ready cue; p2=workflow context; p3=captured account; p4=stable message | run context | execution context |
...
| **applying** | capture facts | execution context | operator knowhow | implementation judgment |
...
PASS. Final result cells are populated, compact, free of algebra notation, and contain no implementation particulars, numeric values, protected payloads, or professional approval claims.
