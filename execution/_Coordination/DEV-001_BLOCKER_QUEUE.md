...
| Implementation evidence records | 41 |
| Committed implementation evidence | 40 |
| Filesystem lifecycle `SEMANTIC_READY` (display only) | 32 |
...
| `DEL-08-04` | `PKG-08` | `WORKING_TREE` | 11 | Result export format |
...
| `DEL-08-04` - Result export format | `PKG-08` | `WORKING_TREE` | 2 | `DEL-10-05`; `DEL-12-02` | `DAG-001-E0569`; `DAG-001-E0613` |
...
| `DEL-10-05` | `PKG-10` | 1 | `DEL-08-04` | Headless CLI and structured I/O analysis runner |
