...
| `DEL-08-01` | `PKG-08` | `WORKING_TREE` `WORKING_TREE` | 14 | Calculation report generator |
...
| `DEL-08-01` - Calculation report generator | `PKG-08` | `WORKING_TREE` | 3 | `DEL-08-05`; `DEL-11-01`; `DEL-12-02` | `DAG-001-E0529`; `DAG-001-E0578`; `DAG-001-E0612` |
