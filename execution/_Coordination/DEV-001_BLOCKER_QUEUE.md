...
| `DEL-13-03` | `PKG-13` | `WORKING_TREE` | 12 | Constraint validation engine |
...
| `DEL-14-05` | `PKG-14` | `WORKING_TREE` | 11 | Comparison mapping, tolerance, and export contracts |
| `DEL-15-01` | `PKG-15` | `WORKING_TREE` | 13 | Canonical handoff package schema and manifest |
...
| `DEL-13-03` - Constraint validation engine | `PKG-13` | `WORKING_TREE` | 3 | `DEL-07-08`; `DEL-13-04`; `DEL-16-02` | `DAG-002-E0775`; `DAG-002-E0828`; `DAG-002-E0845` |
...
| `DEL-14-05` - Comparison mapping, tolerance, and export contracts | `PKG-14` | `WORKING_TREE` | 7 | `DEL-07-08`; `DEL-08-06`; `DEL-14-03`; `DEL-14-04`; `DEL-15-02`; `DEL-15-03`; `DEL-16-02` | `DAG-002-E0793`; `DAG-002-E0796`; `DAG-002-E0810`; `DAG-002-E0817`; `DAG-002-E0830`; `DAG-002-E0850`; `DAG-002-E0865` |
| `DEL-15-01` - Canonical handoff package schema and manifest | `PKG-15` | `WORKING_TREE` | 4 | `DEL-08-06`; `DEL-15-02`; `DEL-15-03`; `DEL-15-04` | `DAG-002-E0805`; `DAG-002-E0811`; `DAG-002-E0819`; `DAG-002-E0866` |
...
| `DEL-07-08` | `PKG-07` | 10 | `DEL-07-02`; `DEL-07-04`; `DEL-07-05`; `DEL-13-03`; `DEL-13-04`; `DEL-14-03`; `DEL-14-04`; `DEL-14-05`; `DEL-16-02`; `DEL-16-03` | Design-authoring state and comparison workspace |
| `DEL-08-06` | `PKG-08` | 6 | `DEL-14-03`; `DEL-14-04`; `DEL-14-05`; `DEL-15-01`; `DEL-15-03`; `DEL-15-04` | State, comparison, and handoff report sections |
| `DEL-11-01` | `PKG-11` | 2 | `DEL-07-03`; `DEL-07-05` | User guide skeleton |
| `DEL-13-04` | `PKG-13` | 1 | `DEL-13-03` | Physical-to-analytical transformation contract |
| `DEL-14-03` | `PKG-14` | 1 | `DEL-14-05` | Model-state comparison engine |
| `DEL-14-04` | `PKG-14` | 1 | `DEL-14-05` | Analysis-run comparison engine |
| `DEL-15-02` | `PKG-15` | 3 | `DEL-15-01`; `DEL-13-04`; `DEL-14-05` | Target mapping and unsupported-behavior contract |
| `DEL-15-03` | `PKG-15` | 4 | `DEL-15-01`; `DEL-15-02`; `DEL-13-04`; `DEL-14-05` | Downstream modeling export workflow |
| `DEL-15-04` | `PKG-15` | 3 | `DEL-15-01`; `DEL-15-02`; `DEL-15-03` | External prover boundary metadata |
| `DEL-16-02` | `PKG-16` | 3 | `DEL-13-03`; `DEL-14-03`; `DEL-14-05` | Operation validation and diff preview |
